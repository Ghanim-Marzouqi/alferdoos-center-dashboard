      ...
      <q-page class="bg-primary window-height window-width flex flex-center">
        <div class="column text-center">
          <div class="col">
            ...
            <p class="text-white text-h6 text-weight-bold">تسجيل دخول المعلم</p>
          </div>
          <div class="row">
...
export default {
  ...
  created() {
    this.TRIGGER_USER_STATE(COLLECTIONS.TEACHERS);
    ...
    GET_USER: function(newState, oldState) {
      if (Object.keys(newState).length > 0) {
        if (newState.isEmailVerified && this.loginMethod === "email") {
          ...
          console.log("TeacherPageLogin: watch(GET_USER) error");
        }
      }
    }
  }
